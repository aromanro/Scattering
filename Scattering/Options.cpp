...
const std::vector<Scattering::ScatteringPair> Options::scatteringPairs = { 
	...
	// for H2 cases higher values of l are needed, probably a better method for Bessel functions calculation should be used
	// for now it does not appear to work all right so I let the values here commented
